...
went_to_store_and_bought_cheese <- went_to_store & bought_cheese
went_to_store_and_bought_cheese
...
## Challenge problem: https://github.com/Bioinformatics-Research-Network/training-requirements/tree/main/R%20Programming
## If you complete this before next session, you'll get a prize
